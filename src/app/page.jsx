      ...
      <main className={styles.main}>
        <h1>Prism</h1>
          ...
          {(samples.length > 0) && <div className={styles.results}>
              ...
              <p className={styles.text}>The way humans percieve colour is <a href={'https://philosophyalevel.com/aqa-philosophy-revision-notes/theories-of-perception/#Indirect'}>intimately wrapped up with layers of meaning we apply to the world</a>; our brains pick out certain objects, or our eyes are tuned to prioritise evolutionarily important colours, thus our view of the world is abstracted from reality from the very moment of perception.
              </p>
              <p className={styles.text}>
